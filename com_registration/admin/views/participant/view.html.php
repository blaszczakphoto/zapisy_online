 ...
 * @since  0.0.1
 */
class RegistrationViewParticipant extends JViewLegacy
{
   /**
    * View form
    *
   ...
   protected function addToolBar()
   {
      ...
      JToolBarHelper::title($isNew ? "Dodaj nowego uczestnika"
            : "Edytuj uczestnika", 'participant');
      ...
      if ($isNew)
      {
         ...
         if ($this->canDo->get('core.create'))
         {
            ...
            JToolBarHelper::custom('participant.save2new', 'save-new.png', 'save-new_f2.png',
      ...
      else
      {
         ...
         if ($this->canDo->get('core.create'))
         {
            JToolBarHelper::custom('participant.save2copy', 'save-copy.png', 'save-copy_f2.png',
